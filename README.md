...
* **Dynamic Gameplay**: Strategically place cards featuring attack values on all four sides to control a 3x3 grid, navigating a roulette built from a pool of 13 rules, including Symmetry, Nectar Math, Pollination, and Swarm to the Death. Includes a ban list to remove rules from roulette.
