    ...
    private var matchRulesSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                // picking a rule turns Force Normal back off — the two are mutually
                // exclusive, not independent toggles.
            ...
            // Footer, outside/below the card rather than above the toggles — reads as
            // an explanation of the card above it, not another heading-level element.
